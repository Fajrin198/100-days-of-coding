...
public class KonversiUang extends JFrame {
    ...
    private JPanel getpanel() {
        if (panel == null) {
            ...
            panel.add(getjtextDollar());
            panel.add(getconvert1());
            panel.add(getlabelRupiah());
            panel.add(getjtextRupiah());
            
            panel.add(getlabelRupiah2());
            panel.add(getjtextRupiah2());
            panel.add(getconvert2());
            panel.add(getlabelDollar2());
            panel.add(getjtextDollar2());
        }
        return panel;
    }
    ...
    private JTextField getjtextDollar() {
        if (jtextDollar == null) {
            ...
            jtextDollar.setPreferredSize(new Dimension(260, 30));
        }
        return jtextDollar;
    }
    ...
    private JTextField getjtextRupiah2() {
        if (jtextRupiah2 == null) {
            ...
            jtextRupiah2.setPreferredSize(new Dimension(260, 30));
        }
        return jtextRupiah2;
    }
